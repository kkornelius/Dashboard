...
<div style="margin-bottom: 2rem;">
    ...
    <p style="color: #6b7280; margin-bottom: 0;">Fill in the form below to add a new client to your CRM.</p>
</div>
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('clients.store') }}">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('notes') is-invalid @enderror" id="notes" name="notes" rows="4" placeholder="Add any notes or comments about this client...">{{ old('notes') }}</textarea>
                        @error('notes')
                            <div class="text-danger">{{ $message }}</div>
                        @enderror
                    </div>
